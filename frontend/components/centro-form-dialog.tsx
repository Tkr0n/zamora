...
export default function CentroFormDialog({
  ...
  const setNum = (key: keyof CreatePuntoInteresPayload, value: string) => {
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input type="number" step="0.0001" required value={form.latitud} onChange={(e) => setNum('latitud', e.target.value)} />
            </div>
            <div>
              <label className="text-sm font-medium">Longitud</label>
              <Input type="number" step="0.0001" required value={form.longitud} onChange={(e) => setNum('longitud', e.target.value)} />
            </div>
          </div>
          <div>
